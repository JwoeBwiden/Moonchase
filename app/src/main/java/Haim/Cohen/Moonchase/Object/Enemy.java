...
/**
 * Enemy is a cahracter which always moves in the direction
 * of the player. The enemy class is an extension of a Circle,
 * which is an extension of a GameObject.
 */
